...
1. Oracle VM VirtualBox，下载地址：https://www.virtualbox.org/wiki/Downloads
2. CentOS7.9，下载地址：https://mirrors.aliyun.com/centos/7.9.2009/isos/x86_64/?spm=a2c6h.25603864.0.0.3dccf5adbnhdJY
...
## 3.3. 验证网卡配置
 ...
 确认网卡已设置为开机自启（检查输出中的`autoconnect`是否为yes）：
